...
namespace CarRent.Contexts.SQLiteContext.Migrations
{
    ...
    [Migration("20200427114632_AddedRentingTable")]
    partial class AddedRentingTable
    {
            ...
            modelBuilder.Entity("CarRent.Contexts.Models.Core.Renting", b =>
                {
                    ...
                    b.Property<DateTime>("Rented")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2020, 4, 27, 13, 46, 32, 193, DateTimeKind.Local).AddTicks(3121));
